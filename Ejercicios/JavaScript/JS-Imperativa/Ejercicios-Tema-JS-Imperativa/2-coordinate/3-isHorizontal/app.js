...
console.writeln(`La coordenada origen (${abcissa1}, ${ordinate1}) y la coordenada destino (${abcissa2}, ${ordinate2}) ${abcissa1 != abcissa2 && ordinate1 == ordinate2 ? 'si' : 'no'} es un movimiento horizontal`);