...
console.writeln(`La división de la fracción ${numerator1}/${denominator1} y la fracción ${numerator2}/${denominator2} es la fracción ${numerator1*denominator2}/${numerator2*denominator1}`);