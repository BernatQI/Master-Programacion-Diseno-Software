...
console.writeln(`La suma de la fracción ${numerator1}/${denominator1} y la fracción ${numerator2}/${denominator2} es la fracción ${numerator1*denominator2 - denominator1*numerator2}/${denominator1*denominator2}`);